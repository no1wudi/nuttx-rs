...
/// Touch event flags matching NuttX TOUCH_* definitions
///
/// These flags indicate the state and validity of touch data
...
/// Touch gesture types matching NuttX TOUCH_* definitions
///
/// These values indicate the type of gesture detected by the touchscreen
